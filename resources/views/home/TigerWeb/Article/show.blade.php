<x-main-layout>
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-10 col-xl-10s">
                <div class="card mb-3">
                ...
                <a href="{{ route('article_list') }}" class="btn btn-secondary"> Cancel </a>
            </div>

            <div class="col-md-2 col-xl-2s">
                <div class="card mb-3">
                    <div class="card">
                        <div class="card-body pb-0">
                            <h5 class="card-title">{{$articleDetails['title']}}  <span>| History</span></h5>
                            @if ($articleDetails->parentTree != null)
                                @include('home.TigerWeb.Article.edit_history', ['items' => $articleDetails->parentTree])
                            @endif
                        </div>
                    </div>
                </div>
