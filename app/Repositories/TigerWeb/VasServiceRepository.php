...
use App\Models\TigerWeb\VasService;
...
class VasServiceRepository  extends AbstractNativeRepository implements VasServiceRepositoryInterface, CrudGridLoaderInterface
{

   public function getModelFqcn(): string
   {
     return VasService::class;
   }
   ...
   public function vasServiceFilterData($filter)
    {
        //return $query = $this->all();
        $query = VasService::query();
