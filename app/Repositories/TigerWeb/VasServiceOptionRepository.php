...
use App\Models\TigerWeb\VasServiceOption;
...
class VasServiceOptionRepository  extends AbstractNativeRepository implements VasServiceOptionRepositoryInterface, CrudGridLoaderInterface
{

   public function getModelFqcn(): string
   {
     return VasServiceOption::class;
   }
   ...
   public function vasServiceOptionFilterData($filter)
    {
        //return $query = $this->all();
        $query = VasServiceOption::query();
